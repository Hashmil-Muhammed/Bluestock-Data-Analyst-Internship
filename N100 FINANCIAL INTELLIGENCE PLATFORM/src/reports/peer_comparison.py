...
def generate_excel_report(db_path='nifty100.db', output_file='output/peer_comparison.xlsx'):
    ...
    df_ratios = pd.read_sql("SELECT company_id, year, ROE, NPM FROM financial_ratios", conn)
    conn.close()
