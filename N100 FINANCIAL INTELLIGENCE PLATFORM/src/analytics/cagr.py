...
class CAGREngine:
    ...
    def run(self):
                ...
                for w in windows: 
                    ...
                    if i >= w:
                        ...
                        for col, name in metrics.items():
                            val, turnaround = self.compute_cagr(prev_row[col], row[col], w)
        ...
        if not turnarounds.empty:
            print("Note: Found Turnaround Companies (Navigate to Positive PAT in 5Y windows):")
            print("\n")
...
if __name__ == '__main__':
    ...
    cols_to_show = ['company_id', 'year', 'Revenue_CAGR_10Y', 'PAT_CAGR_10Y', 'EPS_CAGR_10Y']
