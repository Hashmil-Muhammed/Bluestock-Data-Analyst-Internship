...
def populate_database(db_path='nifty100.db'):
    ...
    cols_to_keep = [
        'company_id', 'year',
        'NPM', 'OPM', 'ROE', 'ROCE', 'D_E', 'ICR', 'Asset_Turnover',
        'Revenue_CAGR_3Y', 'PAT_CAGR_3Y', 'EPS_CAGR_3Y', 'PAT_Turnaround_3Y',
        'Revenue_CAGR_5Y', 'PAT_CAGR_5Y', 'EPS_CAGR_5Y', 'PAT_Turnaround_5Y',
        'Revenue_CAGR_10Y', 'PAT_CAGR_10Y', 'EPS_CAGR_10Y', 'PAT_Turnaround_10Y',
        'FCF', 'CFO_Quality_Score', 'CapEx_Intensity', 'FCF_Conversion', 'Capital_Allocation_Pattern'        
    ]    
