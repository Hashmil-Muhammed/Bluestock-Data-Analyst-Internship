...
import sqlite3
import os
def analyze_banking_roce(db_path='nifty100.db', output_file='reports/sector_roce_notes.csv'):
    ...
    print(f"Processed {len(df)} financial records. Detected {len(anomalies)} anomalies due to standard ROCE formula. \n")
    ...
    if not anomalies.empty:
        ...
        cols_to_show = ['company_id', 'year', 'original_roce', 'calculated_roce', 'roce_difference' ]
