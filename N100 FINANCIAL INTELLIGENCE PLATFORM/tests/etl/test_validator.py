...
def sample_data():
    return {
        'companies': pd.DataFrame({'id': ['RELIANCE', 'TCS'], 'company_name': ['Reliance Industries', 'TCS Ltd']}),
        'profitandloss': pd.DataFrame({'company_id': ['RELIANCE', 'TCS'], 'year': ['2024-03', '2024-03'], 'net_profit': [40000, 35000]})
    }
