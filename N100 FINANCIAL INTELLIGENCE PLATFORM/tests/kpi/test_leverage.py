...
@pytest.fixture
def ratio_engine():
    return ProfitabilityEngine(db_path=':memory:') # Dummy DB path for testing functions

def test_debt_to_equity_bank_carve_out(ratio_engine):
    # 'HDFCBANK' should return None for D/E
    row = {'company_id': 'HDFCBANK', 'borrowings': 5000, 'equity_capital': 100, 'reserves': 900}
...
def test_debt_to_normal(ratio_engine):
    ...
    row = {'company_id': 'TCS', 'borrowings': 500, 'equity_capital': 100, 'reserves':900} # Equity = 1000
